...
class dataPaths():
    ...
    model_2_classes = os.path.join(data_folder, "model_2_classes.npy")
    fineTuned_classes = os.path.join(data_folder, "fineTune_classes.npy")
...
class tokenizerPaths():
    tok_folder = os.path.join(cwd, "backend", "tokenizers")
    distilled_tok_path = os.path.join(tok_folder, "distrilled-tok")
